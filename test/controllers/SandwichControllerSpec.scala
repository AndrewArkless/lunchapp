...
class SandwichControllerSpec extends PlaySpec with GuiceOneAppPerTest {
  ...
  object FakeNoSandwichService extends SandwichService {
    override def sandwiches(): Future[List[Sandwich]] = Future(List[Sandwich]())
  }

  object FakeSingleSandwichService extends SandwichService {
    override def sandwiches(): Future[List[Sandwich]] = Future(List[Sandwich](Sandwich("Ham", 1.55, "Very tasty")))
  }
  ...
  object FakeMultiSandwichService extends SandwichService {
    ...
    override def sandwiches(): Future[List[Sandwich]] =Future(List[Sandwich](ham, cheese, egg))
  }
